  ...
  return (
    <Box sx={{ p: 2, width: 410 }}>
      <Header>
        ...
        <Typography variant="body2">You have unread notifications</Typography>
      </Header>
      <Divider />
      <Box>
        ...
        {newData.map((item, index) => (
          ...
          >
            <ListItemIconStyle>
              <ListItemIcon sx={{ fontSize: "35px", color: "purple" }}>
                {item.icon}
              </ListItemIcon>
              <div>
      ...
      <Box>
        ...
        {olderData.map((item, index) => (
          <ListItemButton
            sx={{ marginY: "4px", borderRadius: "8px" }}
            key={index}
          >
            <ListItemIconStyle>
              <ListItemIcon sx={{ fontSize: "35px", color: "skyblue" }}>
                {item.icon}
              </ListItemIcon>
              <div>
